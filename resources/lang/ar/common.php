...
return [
    ...
    'string' => 'القيمية المدخلة يجب ان تكون حروف',
    'numeric' => 'القيمية المدخلة يجب ان يكون أرقام',
    'max_characters_250' => 'عدد الحروف المسموح بها 250 حرف فقط',
    'unique' => 'القيمية المدخلة موجودة مسبقا',
    'image' => 'يجب ان تكون صورة',
    'image_max' => 'حجم الصورة المسموح به 2 ميجا فقط',
    'mimes' => 'يجب ان تكون صورة باحدي الصيغ png,gif,jpeg,jpg',
    'email' => 'يجب ان يكون علي صيغية ايميل',
    ...
    'remaining' => 'متبقي',
    'are_you_sure_to_delete_record' => 'هل انت متاكد انك تريد حذف هذا السجل ؟',

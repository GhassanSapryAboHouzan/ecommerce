                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive text-center ">
                                            <table class="table table-borderless"
                                                ...
                                                <thead>
                                                <tr>
                                                    <th>{!! __('supervisors.user_image') !!}</th>
                                                    <th>{!! __('supervisors.full_name') !!}</th>
                                                    <th>{!! __('supervisors.email') !!}</th>
                                                    <th>{!! __('supervisors.mobile') !!}</th>
                                                    <th>{!! __('supervisors.status') !!}</th>
                                                    <th>{!! __('supervisors.created_at') !!}</th>
                                                        ...
                                                        <td>
                                                            @if( $supervisor->user_image != null)
                                                                <img class="img-thumbnail"
                                                                     ...
                                                                     src="{{ asset('adminBoard/uploaded_images/users/' . $supervisor->user_image) }}">
                                                            @else
                                                                <img class="img-thumbnail"
                                                                     style="width: 50px ; height: 50px"
                                                        ...
                                                        <td>
                                                            <div>
                                                                ...
                                                                <form
                                                                    ...
                                                                    method="post"
                                                                    id="delete-supervisor-{{ $supervisor->id }}"
                                                                    class="d-none">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                ...
                                                <tr>
                                                    <td colspan="7">
                                                        <div>
                                                            {!! $supervisors->appends(request()->all())->links('vendor.pagination.bootstrap-4') !!}
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tfoot>

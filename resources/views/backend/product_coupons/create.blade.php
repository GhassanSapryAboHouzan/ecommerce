                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">
                                {!! __('product_coupons.product_coupon_create') !!}
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <select class="form-control" name="type" id="type">
                                                <option
                                                    value="fixed" {{ old('type', request()->input('type')) == 'fixed' ? 'selected' : '' }}>
                                                    {!! __('product_coupons.fixed') !!}
                                                </option>
                                                <option
                                                    value="percentage" {{ old('type', request()->input('type')) == 'percentage' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control"
                                                   id="use_times" name="use_times" value="{!! old('use_times') !!}"
                                                   autocomplete="off"

...
@section('content')
    ...
    <form action="{!! route('admin.customer_addresses.update',$customerAddress->id) !!}" method="post"
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">
                                {!! __('customer_addresses.customer_address_update') !!}
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="{!! $customerAddress->user->full_name !!}"
                                                   readonly/>

                                            <input type="hidden" class="form-control"
                                                   id="user_id" name="user_id"
                                                   value="{!! $customerAddress->user_id !!}"
                                                   readonly/>
                                        </div>
                                        @error('user_id')
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <select class="form-control" name="default_address" id="default_address">
                                                <option
                                                    value="1" {{ old('default_address', $customerAddress->default_address) == __('common.active') ? 'selected' : '' }}>
                                                    {!! __('common.active') !!}
                                                </option>
                                                <option
                                                    value="0" {{ old('default_address', $customerAddress->default_address) == __('common.inactive') ? 'selected' : '' }}>
                                                    {!! __('common.inactive') !!}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="{!! old('address', $customerAddress->address) !!}"
                                                   autocomplete="off"
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="{!! old('address2', $customerAddress->address2) !!}"
                                                   autocomplete="off"
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="{!! old('zip_code', $customerAddress->zip_code) !!}"
                                                   autocomplete="off"
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="{!! old('po_box', $customerAddress->po_box) !!}"
                                                   autocomplete="off"
                                            ...
                                            <select class="form-control" id="country_id" name="country_id">
                                                @forelse($countries as $country)
                                                    <option value="{!! $country->id !!}"
                                                        {{ old('country_id', $customerAddress->country_id) == $country->id ? 'selected' : null }}>
                                                        {!! $country->name !!}
                                                    </option>
                                                @empty
                                                @endforelse

<div class=" mb-5 pa mt-10">
    <form class="form" action="{{ route('admin.shipping_companies.index') }}" method="get">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-2">
                <select name="sort_by" class="form-control">
                    ...
                    <option
                        value="first_name" {{ old('sort_by', request()->input('sort_by')) == 'first_name' ? 'selected' : '' }}>
                        {!! __('customers.first_name') !!}
                    </option>
                    <option
                        value="last_name" {{ old('sort_by', request()->input('sort_by')) == 'last_name' ? 'selected' : '' }}>

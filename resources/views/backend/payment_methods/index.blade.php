                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="javascript:void(0);" class="text-muted">
                            {{trans('payment_methods.payment_methods')}}
                        </a>
                    </li>
                                        ...
                                        <div class="table-responsive text-center ">
                                            <table class="table table-borderless"
                                                ...
                                                <tr>
                                                    ...
                                                    <th>{!! __('payment_methods.sandbox') !!}</th>
                                                    <th>{!! __('payment_methods.status') !!}</th>
                                                ...
                                                @forelse($paymentMethods as $paymentMethod)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <a href="{!! route('admin.payment_methods.edit',$paymentMethod->id) !!}"
                                                                ...
                                                                <a href="javascript:void(0)"
                                                                   ...
                                                                   onclick="if (confirm('{!! __('common.are_you_sure_to_delete_record') !!}'))
                                                                       { document.getElementById('delete-payment-method-{{ $paymentMethod->id }}').submit(); }
                                                                       else {
                                                                       return false;
                                                                       }">
                                                                ...
                                                                <form
                                                                    action="{{ route('admin.payment_methods.destroy', $paymentMethod->id) }}"
                                                                    method="post"
                                                                    id="delete-payment-method-{{ $paymentMethod->id }}"
                                                                    class="d-none">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                ...
                                                <tr>
                                                    <td colspan="5">
                                                        <div>
                                                            {!! $paymentMethods->appends(request()->all())->links('vendor.pagination.bootstrap-4') !!}
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tfoot>

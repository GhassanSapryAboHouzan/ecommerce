                                        ...
                                        <div class="table-responsive text-center ">
                                            <table class="table table-borderless"
                                                ...
                                                <tr>
                                                    ...
                                                    <th>{!! __('cities.state_id') !!}</th>
                                                    <th>{!! __('cities.status') !!}</th>
                                                    <th class="text-center">{!! __('cities.actions') !!}</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                            ...
                                                            <div>
                                                                ...
                                                                <a href="javascript:void(0)"
                                                                   ...
                                                                   onclick="if (confirm('{!! __('common.are_you_sure_to_delete_record') !!}'))
                                                                       { document.getElementById('delete-city-{{ $city->id }}').submit(); }
                                                                       else {
                                                                       return false;
                                                                       }">
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <div>
                                                            {!! $cities->appends(request()->all())->links('vendor.pagination.bootstrap-4') !!}
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tfoot>

                                        ...
                                        <div class="input-group">
                                            <select class="form-control" id="product_category_id"
                                                ...
                                                @foreach($categories as $category)
                                                    <option
                                                        value="{!! $category->id !!}" {!! old('product_category_id')==$category->id ? 'selected':'' !!}>
                                                        {!! $category->name !!}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-10 col-xl-10">
                                        <div class="input-group">
                                            <select class="form-control" name="featured" id="featured">
                                                <option
                                                    value="1" {{ old('featured', request()->input('featured')) == 1 ? 'selected' : '' }}>
                                                    {!! __('common.yes') !!}
                                                </option>
                                                <option
                                                    value="0" {{ old('featured', request()->input('featured')) == 0 ? 'selected' : '' }}>
                                                    {!! __('common.no') !!}
                                                </option>
                                            </select>

                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="javascript:void(0);" class="text-muted">
                            {{trans('product_categories.product_categories')}}
                        </a>
                    </li>
                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive text-center ">
                                            <table class="table table-borderless"
                                                ...
                                                <thead>
                                                <tr>
                                                    <th>{!! __('product_categories.image') !!}</th>
                                                    <th>{!! __('product_categories.name') !!}</th>
                                                    <th>{!! __('product_categories.product_count') !!}</th>
                                                    <th>{!! __('product_categories.parent') !!}</th>
                                                    <th>{!! __('product_categories.status') !!}</th>
                                                    <th>{!! __('product_categories.create_at') !!}</th>
                                                    <th class="text-center">{!! __('product_categories.actions') !!}</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                        ...
                                                        <td>
                                                            @if( $category->image != null)
                                                                <img class="img-thumbnail"
                                                                     ...
                                                                     src="{{ asset('adminBoard/uploaded_images/product_categories/' . $category->image) }}">
                                                            @else
                                                                <img class="img-thumbnail"
                                                                     style="width: 50px ; height: 50px"

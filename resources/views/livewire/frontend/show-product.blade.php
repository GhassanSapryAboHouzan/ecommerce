    ...
    <div class="row align-items-stretch mb-4">
        <div class="col-sm-5 pr-sm-0">
            <div
                ...
                <div class="quantity">
                    <button wire:click.prevent="decreaseQuantity()" class="p-0"><i class="fas fa-caret-left"></i>
                    </button>
                    <input type="text" wire:model="quantity" class="form-control border-0 shadow-0 p-0">
                    <button wire:click.prevent="increaseQuantity()" class=" p-0"><i class="fas fa-caret-right"></i>
                    </button>
                </div>
        ...
        <div class="col-sm-3 pl-sm-0">
            <a wire:click.prevent="addToCart()"
               class="btn btn-primary btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0">
                Add to cart
            </a>
        </div>
    </div>
    <a wire:click.prevent="addToWishList()"

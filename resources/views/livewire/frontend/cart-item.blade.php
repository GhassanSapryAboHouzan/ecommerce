<tr x-data="{ show: true }" x-show="show">
    <th class="pl-0 border-0" scope="row">
        <div class="media align-items-center">
            <a class="reset-anchor d-block animsition-link"
               href="{!! route('product',$cartItem->model->slug) !!}">
                <img width="70"
                     src="{!! asset('adminBoard/uploaded_images/products/'.$cartItem->model->firstMedia->file_name) !!}"
    ...
    <td class="align-middle border-0">
        <div class="border d-flex align-items-center justify-content-between px-3"><span
            ...
            <div class="quantity">
                ...
                <button wire:click.prevent="decreaseQuantity('{!! $cartItem->rowId !!}')" class="p-0">
                ...
                <button wire:click.prevent="increaseQuantity('{!! $cartItem->rowId !!}')"
                        class="inc-btn p-0">
    ...
    <td class="align-middle border-0">
        <a wire:click.prevent="$emit('removeFromCart','{!! $cartItem->rowId !!}')"

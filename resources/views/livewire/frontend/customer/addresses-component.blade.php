<div x-data="{formShow: @entangle('showForm')}">
    <div class="d-flex">
        ...
        <div class="ml-auto">
            <button @click="formShow = true" type="button" class="btn btn-primary rounded shadow">
                Add new address
            </button>
        </div>
    </div>
    ...
    <form wire:submit.prevent="{{ $editMode == true ? 'updateAddress' : 'saveAddress' }}" x-show="formShow"
          @click.away="formShow = false">
        <div class="row">

            @if($editMode == true)
                <input class="form-control" wire:model="address_id" type="text">
            @endif
            ...
            <div class="col-lg-4 form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" id="default_address" wire:model="default_address"
                           type="checkbox">
            ...
            <div class="col-lg-12 form-group">
                <button class="btn btn-dark" type="submit">
                    {!! $editMode==true ? 'Update Address' : 'Add address' !!}
                </button>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group btn-group-sm">
                                <button wire:click.prevent="editAddress('{!! $address->id !!}')"
